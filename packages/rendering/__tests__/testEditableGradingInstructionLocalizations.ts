...
describe('testEditableGradingInstructionLocalization.ts — Grading instruction localize editing', () => {
  ...
  it('renders all grading instructions regardless the localization (language or exam type)', async () => {
    ...
    expect(valueFi).toContain(
      '<p>Normaali tekstikappale <br> <e:localization>Lokalisaatio: Ei attribuutteja <br></e:localization> <e:localization lang="fi-FI">Lokalisaatio: FI only <br> <e:localization lang="fi-FI" exam-type="hearing-impaired" hidden="hidden">Lokalisaatio: FI KV (supports localization nesting) <br></e:localization></e:localization> <e:localization lang="fi-FI" exam-type="visually-impaired">Lokalisaatio: FI NV <br></e:localization> <e:localization lang="fi-FI" exam-type="visually-impaired">Lokalisaatio: FI NV <br></e:localization> <e:localization lang="sv-FI" hidden="hidden">Lokalisaatio: SV only <br></e:localization> <e:localization lang="sv-FI" exam-type="hearing-impaired" hidden="hidden">Lokalisaatio: SV KV <br></e:localization> <e:localization lang="sv-FI" exam-type="visually-impaired" hidden="hidden">Lokalisaatio: SV NV <br></e:localization> <e:localization exam-type="hearing-impaired" hidden="hidden">Lokalisaatio: KV only <br></e:localization> <e:localization exam-type="visually-impaired">Lokalisaatio: NV only <br></e:localization><br class="ProseMirror-trailingBreak"></p>'
    )
    ...
    expect(valueSv).toContain(
      '<p>Normaali tekstikappale <br> <e:localization>Lokalisaatio: Ei attribuutteja <br></e:localization> <e:localization lang="fi-FI" hidden="hidden">Lokalisaatio: FI only <br> <e:localization lang="fi-FI" exam-type="hearing-impaired" hidden="hidden">Lokalisaatio: FI KV (supports localization nesting) <br></e:localization></e:localization> <e:localization lang="fi-FI" exam-type="visually-impaired" hidden="hidden">Lokalisaatio: FI NV <br></e:localization> <e:localization lang="fi-FI" exam-type="visually-impaired" hidden="hidden">Lokalisaatio: FI NV <br></e:localization> <e:localization lang="sv-FI">Lokalisaatio: SV only <br></e:localization> <e:localization lang="sv-FI" exam-type="hearing-impaired">Lokalisaatio: SV KV <br></e:localization> <e:localization lang="sv-FI" exam-type="visually-impaired" hidden="hidden">Lokalisaatio: SV NV <br></e:localization> <e:localization exam-type="hearing-impaired">Lokalisaatio: KV only <br></e:localization> <e:localization exam-type="visually-impaired" hidden="hidden">Lokalisaatio: NV only <br></e:localization><br class="ProseMirror-trailingBreak"></p>'
    )
  })
  ...
  it('hides grading instruction localizations not belonging to the opened page', async () => {
    ...
    expect(value).toContain('<e:localization lang="fi-FI" exam-type="hearing-impaired" hidden="hidden">')
