...
const GradingInstruction: React.FunctionComponent<ExamProps> = ({ doc }) => {
    ...
    <I18nextProvider i18n={i18n}>
      <main className="e-exam e-grading-instructions" lang={subjectLanguage}>
        ...
        <SectionElement aria-labelledby={examTitleId}>
          ...
          <h2>Hyvän vastauksen piirteitä</h2>
...
export default React.memo(withExamContext(withCommonExamContext(GradingInstruction)))
