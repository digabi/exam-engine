...
export const sv_FI: Translations = {
  ...
  undo: {
    ...
    answerWordCount_other: '{{count}} ord',
    answerCharacterCount: '{{count}} tecken',
    answerCharacterCount_other: '{{count}} tecken',
    answerImageCount: '{{count}} bild',
    answerImageCount_other: '{{count}} bilder',
  ...
  'max-answers-warning_other': 'Besvara högst {{count}} uppgifter.',
  'open-writing-mode': 'Öppna skrivvyn',
  'close-writing-mode': 'Minska vyn',
  'listen-times-remaining': '{{count}} lyssningsgång kvar.',
  'listen-times-remaining_other': '{{count}} lyssningsgånger kvar.',
