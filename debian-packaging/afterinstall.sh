...
function afterinstall() {
    ...
    exams=( MexDocumentation FF A_X )
    for exam in "${exams[@]}"
    do
        mkdir -p /home/digabi/Työpöytä/mex-demo/$exam
        cp /home/digabi/exam-engine/exams/$exam/$exam.xml /home/digabi/Työpöytä/mex-demo/$exam/koe.xml
        ...
        cp -r /home/digabi/exam-engine/exams/$exam/attachments /home/digabi/Työpöytä/mex-demo/$exam
